//compilar com gcc T4Sequencial.c -o T4Sequencial
//para rodar apos compilado ./T4Sequencial
#include <string.h>
#include <stdlib.h>
#include <stdio.h>
#include <time.h>
...
int ocorrencias_palavra_chave[4] = {0};
...
int main()
{
    ...
    while (fgets(linha, TAM_LINHA, arquivo_texto)) {
        int i;
